        ...
        <div className="p-6 max-w-2xl mx-auto">
            ...
            <form onSubmit={handlePasswordSubmit(onPasswordSubmit)} className="space-y-4 mb-8">
                <div>
                    ...
                    />
                    <label htmlFor="password" className="block text-sm font-medium text-gray-700">Repeat New
                        Password</label>
                    <input
                        id="repeat-password"
                        type="password"
            ...
            <form className="space-y-4">
                <div>
                    <label htmlFor="profileImage" className="block text-sm font-medium text-gray-700">Profile
                        Image</label>
                    <input
                        id="profileImage"
                        type="file"
